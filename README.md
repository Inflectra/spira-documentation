...
5. The script will run, copying files into the `./temp` folder in the root directory as it goes. These markdown files and the images should be pasted into the `./docs` directory in the appropriate folders.
