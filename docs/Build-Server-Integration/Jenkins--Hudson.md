...
Enter in the **URL** you use to access your instance of Spira, together with a valid **username** and **API Key**. You can find or generate the API Key from your user profile page inside Spira - read
