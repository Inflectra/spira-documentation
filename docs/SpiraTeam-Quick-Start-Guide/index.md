# SpiraTeam Quick Start Guide

!!! tip "Want to access the new and improved Quick Start Guide?"
    This SpiraTeam quick start guide still works great, but we have a newer and greater quick start guide. Please feel free to [check it out](../SpiraPlan-Quick-Start-Guide/index.md).
