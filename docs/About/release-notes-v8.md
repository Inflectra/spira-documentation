...
??? success "New Features"
    - Spira meets all WCAG 2.1 AA standards across all parts of the application, so that the application is more accessible and usable for everyone [RQ:5592]

??? bug "Bug fixes and enhancements"
    - Fix being unable to resize the side bar on an artifact's detail page [IN:11901]
    - Add support for new options for Jira and GitLab dataSyncs [IN:12140] [IN:12133]
    - Fix a bug preventing the Inflectra.ai sidebar from loading in some trial instances [IN:12138]
    - Fix a bug where the scrollbar was not showing on left-hand sidebar panels on artifact details pages [IN:12071]
