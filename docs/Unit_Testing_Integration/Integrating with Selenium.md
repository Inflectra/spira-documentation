...
your Selenium tests within the context of an [NUnit test fixture](../Integrating%20with%20NUnit/). Once you have configured NUnit for use
...
your Selenium tests within the context of a [TestNG test fixture](../Integrating%20with%20TestNG/). 
...
run your Selenium tests within the context of a [PyUnit unit-test fixture](../Integrating%20with%20PyUnit/). 
