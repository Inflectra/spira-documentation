...
If the Tree view is selected, which refers to the hierarchical view, filtering will show all requirements without children matching the filter, as well as all parents of those matching requirements. This will show, for each matching requirement, its hierarchy.

![](img/Requirements_Management_TreeView.png)

If the **List** view is selected, which refers to a flat list of requirements, filtering will show all requirements matching the filter only.
