...
!!! info "Custom Property types should exactly match in both applications"
     ...
     1. **Custom Field Type Compatibility**: When mapping fields, ensure that the selected data types correspond exactly between systems. Use the table below as a guide for proper type alignment:     
