...
Install the library with this command: `npm install spira-addons-xunit`

## How to Use the Integration
The integration consists of a Node.js module called `spira_xunit_reader.js` that you call after the unit tests have completed and the XML report file created. 
...
### Executing the Tests
Now you are ready to execute your tests and send the results back to Spira. This happens in two steps:
...
Next, you need to run the Spira results parser module `spira_xunit_reader.js` to upload the results to Spira.
...
For example, with the sample tests you can use either:
    ...
    <testsuite name="LIS.Registration" tests="8" failures="1" errors="1" skipped="1"
        ...
        <testcase name="registration5" classname="LIS.Registration" assertions="2"
            ...
            <properties>
                ...
                <property name="attachment1" value="https://github.com/Inflectra/spira-addons-xunit-node/tree/main/samples/screenshots/home.png" />
                <property name="attachment2" value="https://github.com/Inflectra/spira-addons-xunit-node/tree/main/samples/screenshots/login.png" />
            </properties>
        </testcase>
...
This Node.js version supports all the same features as the [Python version](https://github.com/Inflectra/spira-addons-xunit-python):
